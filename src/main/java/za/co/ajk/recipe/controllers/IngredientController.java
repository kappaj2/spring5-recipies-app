...
import za.co.ajk.recipe.services.IngredientService;
import za.co.ajk.recipe.services.RecipeService;
import za.co.ajk.recipe.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public Model test1(Model model){
        model.addAttribute("TestString","Test string value");
        return model;
    }
}
